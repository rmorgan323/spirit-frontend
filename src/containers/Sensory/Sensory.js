      ...
      <div className="Sensory">
        ...
        <div className="category-content">
          ...
          <CategorySliders 
            ...
            databaseNamesArray={['sen_3_sequencing', 'sen_3_gestalt', 'sen_3_selection', 'sen_3_expansion', 'sen_3_modification']}
          />
          <CategorySliders 
            title={'Execution'}
            slidersArray={['Timing', 'Timing/Force', 'Spatial', 'Temporal', 'Control (Postural; FF; FB)', 'Monitoring']}
            databaseNamesArray={['sen_4_timing', 'sen_4_force', 'sen_4_spatial', 'sen_4_temporal', 'sen_4_control', 'sen_4_monitoring']}
          />
          <CategorySliders 
