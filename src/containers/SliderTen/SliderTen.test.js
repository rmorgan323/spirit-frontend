...
import { mockSliderTitle, mockDatabaseName } from '../../data/mockData/mockCategorySlidersData';
...
describe('SliderTen tests', () => {
  ...
  it('should return a className without thread-connection when slider has been changed', () => {
    ...
    expect(renderedApp.instance().checkThreadConnection(2, 'a', true)).toEqual(expected);
  });
});
