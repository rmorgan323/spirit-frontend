    ...
    <div className="Postural">
      ...
      <div className="category-content">
        ...
        <CategorySliders 
          ...
          slidersArray={['Stability', 'Mobility', 'Tonic', 'Phasic', 'Muscle Tone']}
          databaseNamesArray={['pos_2_stability', 'pos_2_mobility', 'pos_2_tonic', 'pos_2_phasic', 'pos_2_muscle']}
        />
        <CategorySliders 
        ...
        <CategorySliders
          ...
          databaseNamesArray={['pos_5_suck', 'pos_5_ocular', 'pos_5_antigravity', 'pos_5_reflex', 'pos_5_alignment_COG', 'pos_5_alignment_orient', 'pos_5_anticipatory', 'pos_5_interactive']}
        />
        <CategorySliders 
          title={'Voluntary Actions'}
          slidersArray={['Push/Pull/Reach', 'Bilateral Symmetrical/Bilateral Asymmetrical/Unilateral', 'Grasp/Release', 'Strength/Endurance/Flexibility/BMI', 'Effortful Control']}
          databaseNamesArray={['pos_6_push', 'pos_6_bilateral', 'pos_6_grasp', 'pos_6_strength', 'pos_6_effortful']}
        />
      </div>
    </div>
  )
