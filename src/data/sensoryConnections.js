...
const sensoryConnections = {
  sen_1_ability: ['executive', 'sen_2_affordance', 'exe_2b_global', 'sen_6_visual'],
  ...
  sen_2_imitation: ['postural', 'social', 'pos_5_interactive', 'sen_2_imitation', 'soc_2_imitation'],
  ...
  sen_5_ocular: ['exectuive', 'postural', 'exe_1_orient'],
